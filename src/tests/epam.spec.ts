...
test.describe(
  ...
  () => {
    test("[ @epam-1 ] Check the title is correct", async ({
      page,
      epamPage,
    }) => {
    ...
    test("[ @epam-2 ] Check the ability to switch Light / Dark mode", async ({
      page,
      epamPage,
    }) => {
      await test.step("Open EPAM.com", async () => {
    ...
    test("[ @epam-3 ] Check that allow to change language to UA", async ({
      page,
      epamPage,
    }) => {
      await test.step("Open EPAM.com", async () => {
    ...
    test("[ @epam-5 ] Check that allow to switch location list by region", async ({
      page,
      epamPage,
    }) => {
      await test.step("Open EPAM.com", async () => {
